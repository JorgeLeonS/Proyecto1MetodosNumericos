...
public class CongruencialLinealMultiplicativo : MonoBehaviour
{
    ...
    public void generarNumeros(){
       ...
       /* List<float> listPrueba = new List<float>();
        listPrueba.Add(0.018f);
        listPrueba.Add(0.037f);
        listPrueba.Add(0.156f);
        listPrueba.Add(0.191f);
        listPrueba.Add(0.213f);
        listPrueba.Add(0.233f);
        listPrueba.Add(0.281f);
        listPrueba.Add(0.383f);
        listPrueba.Add(0.392f);
        listPrueba.Add(0.408f);
        listPrueba.Add(0.411f);
        listPrueba.Add(0.434f);
        listPrueba.Add(0.469f);
        listPrueba.Add(0.541f);
        listPrueba.Add(0.553f);
        listPrueba.Add(0.575f);
        listPrueba.Add(0.598f);
        listPrueba.Add(0.668f);
        listPrueba.Add(0.671f);
        listPrueba.Add(0.711f);
        listPrueba.Add(0.719f);
        listPrueba.Add(0.73f);
        listPrueba.Add(0.77f);*/
